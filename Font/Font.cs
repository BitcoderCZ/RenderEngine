...
{
    public class GlyphBitmap : ICloneable
    {
    ...
    public class FontGlyph : ICloneable
    {
    ...
    public class Font : IDisposable
    {
        ...
        public Font(byte[] bytes, int id)
        {
            ...
            int numTables = (int)(ReadU16(cmap + 2));
            this._indexMap = 0;
            ...
            Console.WriteLine("Loaded from bytes in " + (DateTime.Now - start).TotalSeconds + " seconds");
        }
